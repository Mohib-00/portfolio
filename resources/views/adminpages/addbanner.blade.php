                       ...
                       <div class="col-md-12">
                          <div class="white_shd full margin_bottom_30">
                            <div class="full graph_head">
                                ...
                                <button class="addbanner">Add</button>
                                   ...
                                   <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="user-row" id="banner-{{ $banner->id }}">
                                                ...
                                                <td>
                                                    <a data-banner-id="{{ $banner->id }}" class="btn btn-warning edit-banner-btn">
                                                ...
                                                <td>
                                                    <a data-banner-id="{{ $banner->id }}" class="btn btn-danger delbanner">
                ...
                Swal.fire({
                    ...
                    const newRow = `
                        <tr data-banner-id="${banner.id}">
                            ...
                            <td>
                                <a id="banneredit" data-banner-id="${banner.id}" class="btn btn-warning edit-banner-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
        ...
        success: function (response) {
            ...
            if (response.success) {
                Swal.fire({
                    ...
                    banner.find('td:nth-child(4)').text(response.banner.paragraph);
                });
            } else {
                Swal.fire({
                    icon: 'error',
