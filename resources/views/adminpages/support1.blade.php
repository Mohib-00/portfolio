                       ...
                       <div class="col-md-12">
                          <div class="white_shd full margin_bottom_30">
                            <div class="full graph_head">
                                ...
                                <button class="addsupport1">Add</button>
                                   ...
                                   <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="user-row" id="support1-{{ $support1->id }}">
                                                ...
                                                <td>
                                                    <a data-support1-id="{{ $support1->id }}" class="btn btn-warning edit-support1-btn">
                                                ...
                                                <td>
                                                    <a data-support1-id="{{ $support1->id }}" class="btn btn-danger delsupport1">
                ...
                Swal.fire({
                    ...
                    const newRow = `
                        <tr data-support1-id="${support1.id}">
                            ...
                            <td>
                                <a id="support1edit" data-support1-id="${support1.id}" class="btn btn-warning edit-support1-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
