                       ...
                       <div class="col-md-12">
                          <div class="white_shd full margin_bottom_30">
                            <div class="full graph_head">
                                ...
                                <button class="addkhabar">Add</button>
                                   ...
                                   <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="user-row" id="khabar-{{ $khabar->id }}">
                                                ...
                                                <td>
                                                    <a data-khabar-id="{{ $khabar->id }}" class="btn btn-warning edit-khabar-btn">
                                                ...
                                                <td>
                                                    <a data-khabar-id="{{ $khabar->id }}" class="btn btn-danger delkhabar">
                ...
                Swal.fire({
                    ...
                    const newRow = `
                        <tr data-khabar-id="${khabar.id}">
                            ...
                            <td>
                                <a id="khabaredit" data-khabar-id="${khabar.id}" class="btn btn-warning edit-khabar-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
