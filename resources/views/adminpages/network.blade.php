                       ...
                       <div class="col-md-12">
                          <div class="white_shd full margin_bottom_30">
                            <div class="full graph_head">
                                ...
                                <button class="addnetwork">Add</button>
                                   ...
                                   <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="user-row" id="network-{{ $network->id }}">
                                                ...
                                                <td>
                                                    <a data-network-id="{{ $network->id }}" class="btn btn-warning edit-network-btn">
                                                ...
                                                <td>
                                                    <a data-network-id="{{ $network->id }}" class="btn btn-danger delnetwork">
                ...
                Swal.fire({
                    ...
                    const newRow = `
                        <tr data-network-id="${network.id}">
                            ...
                            <td>
                                <a id="networkedit" data-network-id="${network.id}" class="btn btn-warning edit-network-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
