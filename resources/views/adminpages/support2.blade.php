                       ...
                       <div class="col-md-12">
                          <div class="white_shd full margin_bottom_30">
                            <div class="full graph_head">
                                ...
                                <button class="addsupport2">Add</button>
                                   ...
                                   <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="user-row" id="support2-{{ $support2->id }}">
                                                ...
                                                <td id="heading">{{$support2->heading}}</td>  
                                                <td id="paragraph">{{$support2->paragraph}}</td> 
                                                <td>
                                                    <a data-support2-id="{{ $support2->id }}" class="btn btn-warning edit-support2-btn">
                                                ...
                                                <td>
                                                    <a data-support2-id="{{ $support2->id }}" class="btn btn-danger delsupport2">
        ...
        <div style="display:none" class="custom-modal support2" aria-hidden="true" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 style="font-weight: bolder" class="modal-title">Add support2</h2>
         ...
         <div style="display:none" class="custom-modal support2edit" aria-hidden="true" tabindex="-1">
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 style="font-weight: bolder" class="modal-title">Edit support2</h2>
                        <button type="button" class="close closeModal" style="background: transparent; border: none; font-size: 2.5rem; color: #333;">
                            &times;
                        </button>
                    </div>
                ...
                Swal.fire({
                    ...
                    const newRow = `
                        <tr data-support2-id="${support2.id}">
                            ...
                            <td>${support2.heading}</td>
                            <td>${support2.paragraph}</td>
                            <td>
                                <a id="support2edit" data-support2-id="${support2.id}" class="btn btn-warning edit-support2-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
    ...
    $.ajax({
        ...
        success: function (response) {
            ...
            if (response.success) {
                ...
                $('#support2editform #heading_edit').val(response.support2.heading);
        ...
        success: function (response) {
            ...
            if (response.success) {
                Swal.fire({
                    ...
                    support2.find('td:nth-child(3)').text(response.support2.heading);
                    support2.find('td:nth-child(4)').text(response.support2.paragraph);
                });
            } else {
                Swal.fire({
                    icon: 'error',
