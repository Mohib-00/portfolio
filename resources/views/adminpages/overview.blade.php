                       ...
                       <div class="col-md-12">
                          <div class="white_shd full margin_bottom_30">
                            <div class="full graph_head">
                                ...
                                <button class="addoverview">Add</button>
                                   ...
                                   <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="user-row" id="overview-{{ $overview->id }}">
                                                ...
                                                <td>
                                                    <a data-overview-id="{{ $overview->id }}" class="btn btn-warning edit-overview-btn">
                                                ...
                                                <td>
                                                    <a data-overview-id="{{ $overview->id }}" class="btn btn-danger deloverview">
                ...
                Swal.fire({
                    ...
                    const newRow = `
                        <tr data-overview-id="${overview.id}">
                            ...
                            <td>
                                <a id="overviewedit" data-overview-id="${overview.id}" class="btn btn-warning edit-overview-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
