                       ...
                       <div class="col-md-12">
                          <div class="white_shd full margin_bottom_30">
                            <div class="full graph_head">
                                ...
                                <button class="addresource">Add</button>
                                   ...
                                   <table class="table">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="user-row" id="resource-{{ $resource->id }}">
                                                ...
                                                <td>
                                                    <a data-resource-id="{{ $resource->id }}" class="btn btn-warning edit-resource-btn">
                                                ...
                                                <td>
                                                    <a data-resource-id="{{ $resource->id }}" class="btn btn-danger delresource">
                ...
                Swal.fire({
                    ...
                    const newRow = `
                        <tr data-resource-id="${resource.id}">
                            ...
                            <td>${resource.name}</td>
                            <td>
                                <a id="resourceedit" data-resource-id="${resource.id}" class="btn btn-warning edit-resource-btn">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pen-fill" viewBox="0 0 16 16">
